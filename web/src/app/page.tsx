      ...
      <div className="w-full flex-1 flex flex-col items-center pt-[12vh] px-8 relative">
        ...
        <div className="w-full max-w-[400px] mt-6 relative z-10">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-3.5 bg-white border border-gray-200 rounded-[20px] hover:bg-gray-50 transition-colors shadow-sm active:scale-95 text-sm font-bold text-gray-700">
            ...
            <button className="flex items-center justify-center gap-2 py-3.5 bg-white border border-gray-200 rounded-[20px] hover:bg-gray-50 transition-colors shadow-sm active:scale-95 text-sm font-bold text-gray-900">
